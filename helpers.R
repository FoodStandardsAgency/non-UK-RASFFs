...
standardise_products <- function(data_frame){
  df <- data_frame %>%
    ...
    mutate_replace_product(
      old_string='brazil nut', new_string='Brazil Nuts'
      ) %>%
    mutate_replace_product(
      old_string='brazilnut', new_string='Brazil Nuts'
      ) %>%
    mutate_replace_product(
    ...
    mutate_replace_product(
      old_string='beef', new_string='Beef'
      ) %>%
    mutate_replace_product(
      old_string='rump steak', new_string='Beef'
      ) %>%
    mutate_replace_product(
